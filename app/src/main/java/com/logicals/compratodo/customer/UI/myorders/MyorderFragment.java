...
public class MyorderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userDTO=sharedPrefrence.getParentUser(Consts.USER_DTO);
            ...
            /* order_details = root.findViewById(R.id.order_details);
...
*/
    ...
    private void get_Pending_List() {
        ...
        new HttpsRequest(Consts.PendingList, param, mContext).stringPost("TAG", new Helper() {
            @Override
    ...
    private void setList() {
          //  binding.tvOrder.setVisibility(View.VISIBLE);
            ...
            myorderAdapter = new MYorderAdapter(mContext,myOrderDTOS,"cancel");
