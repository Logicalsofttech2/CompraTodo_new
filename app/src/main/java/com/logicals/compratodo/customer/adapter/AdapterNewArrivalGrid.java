...
import com.logicals.compratodo.databinding.AdapterNewArrivalGridBinding;
import com.logicals.compratodo.interfacess.Consts;
import com.logicals.compratodo.model.ProductDTO;

import java.util.ArrayList;

    public class AdapterNewArrivalGrid extends RecyclerView.Adapter<AdapterNewArrivalGrid.MyViewHolder> {
        LayoutInflater inflater;
        AdapterNewArrivalGridBinding binding;
        Context mContext;
        ArrayList<ProductDTO> productDTOS = new ArrayList<>();
        Home2Fragment fragment;

        public AdapterNewArrivalGrid(Context mContext, ArrayList<ProductDTO> productDTOS) {
        ...
        @NonNull
        @Override
        public AdapterNewArrivalGrid.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            if (inflater == null) {
                inflater = LayoutInflater.from(parent.getContext());
            }
            binding = DataBindingUtil.inflate(inflater, R.layout.adapter_new_arrival_grid, parent, false);

            return new AdapterNewArrivalGrid.MyViewHolder(binding);
        }

        @Override
        public void onBindViewHolder(@NonNull AdapterNewArrivalGrid.MyViewHolder holder, int position) {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            public MyViewHolder(@NonNull AdapterNewArrivalGridBinding view) {
                super(view.getRoot());
                this.binding = view;
            }
        }
