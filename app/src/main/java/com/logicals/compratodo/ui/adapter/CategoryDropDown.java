...
public class CategoryDropDown extends ArrayAdapter {

    private Context mContext;
    private ArrayList<CategoryDTO> foodTypeLists;
    private LayoutInflater inflater;

    public CategoryDropDown(Context mContext, int resource, ArrayList<CategoryDTO>foodTypeLists) {
