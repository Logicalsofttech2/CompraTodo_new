...
import com.logicals.compratodo.databinding.ActivityVendorChangePasswordBinding;
...
public class VendorChangePassword extends AppCompatActivity {
    ActivityVendorChangePasswordBinding binding;
  ...
  //  String email="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_vendor_change_password);
        mContext=VendorChangePassword.this;
       /*
        ...
        sharedPrefrence=SharedPrefrence.getInstance(VendorChangePassword.this);
    ...
    private void changepassword() {
        ...
        param.put(Consts.EMAIL, userDTO.getUsername());
        ...
        new HttpsRequest(Consts.CHANGE_PASSWORD, param, mContext).stringPost(TAG, new Helper() {
            @Override
